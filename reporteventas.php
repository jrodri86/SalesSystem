<?php
	function imprimirEncabezado($margenizq) {
		...
		$pdf->Cell(0, 5, "DATOS DE LA VENTAS EFECTUADAS", 0, 0, "C", 0);
		$pdf->Ln(15);
		...
		$pdf->MultiCell($aC2,8,"TIPO",1,"C",1,0);
		$pdf->MultiCell($aC3,8,"PRODUCTO",1,"C",1,0);
		$pdf->MultiCell($aC4,8,"VALOR",1,"C",1,1);
	...
	while ($registro = mysqli_fetch_array($res)) {
		...
		$pdf->MultiCell(22,8,$registro["tipo"],1,"C",0,0);
		$pdf->MultiCell(50,8,$registro["producto"],1,"L",0,0);
		$pdf->MultiCell(30,8,$registro["valor"],1,"R",0,1);
		$y = $pdf->GetY();
		$ret=$pdf->getMargins();
